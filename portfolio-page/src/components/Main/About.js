        ...
        <Card variant="outlined" className='about__card' sx={{background: '#E7F6F2'}}> 
          <div className='about__content'>
            ...
            <div className='about__body'>
              <br></br>
              <p>Thanks for stopping by! My name's Sean Keane. I live and try and keep dry in Portland, Oregon. I'm a dual Irish/Canadian citizen who you'll find happiest with a cup of Barry's Irish breakfast tea and a bowl of poutine. I am a junior web developer who is excited to transition my career into software engineering!</p> 
              <br> 
              </br>
